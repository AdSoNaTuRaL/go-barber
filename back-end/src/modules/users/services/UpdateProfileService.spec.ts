...
describe('UpdateProfile', () => {
    ...
    it('should be not able to update the profile information from non-existing user', async () => {
        await expect(
    ...
    it('should not be able to change the email for another already in use', async () => {
